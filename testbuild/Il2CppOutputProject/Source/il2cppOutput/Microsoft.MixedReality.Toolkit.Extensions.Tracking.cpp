...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void LostTrackingService__ctor_mB461F26CCF55EDA9035E52D38106C6E91210ED70 (LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583 * __this, String_t* ___name0, uint32_t ___priority1, BaseMixedRealityProfile_tB4DC16619B37D298D22571CE017070A78EF826E8 * ___profile2, const RuntimeMethod* method)
{
	...
	}
	{
		...
		__this->set_lastTrackingState_13(0);
		// private NotTrackingReason lastNotTrackingReason = NotTrackingReason.None;
		__this->set_lastNotTrackingReason_14(0);
...
IL_0024:
		{
			...
			int32_t L_7 = __this->get_lastTrackingState_13();
...
IL_0032:
		{
			...
			int32_t L_10 = __this->get_lastNotTrackingReason_14();
...
IL_007c:
		{
			...
			__this->set_lastTrackingState_13(L_18);
			...
			__this->set_lastNotTrackingReason_14(L_20);
			IL2CPP_LEAVE(0xA6, FINALLY_0097);
		}
	} // end try (depth: 1)
...
IL_002a:
		{
			...
			LostTrackingServiceProfile_t4937935866E385ED4DE1FD95AA686C18A267E075 * L_8 = __this->get_profile_9();
			NullCheck(L_8);
...
IL_0059:
		{
			...
			LostTrackingServiceProfile_t4937935866E385ED4DE1FD95AA686C18A267E075 * L_12 = __this->get_profile_9();
			NullCheck(L_12);
...
IL_001d:
		{
			...
			LostTrackingServiceProfile_t4937935866E385ED4DE1FD95AA686C18A267E075 * L_4 = __this->get_profile_9();
			NullCheck(L_4);
...
IL_008f:
		{
			...
			LostTrackingServiceProfile_t4937935866E385ED4DE1FD95AA686C18A267E075 * L_22 = __this->get_profile_9();
			NullCheck(L_22);
			...
			// if (profile.HaltTimeWhileTrackingLost)
			LostTrackingServiceProfile_t4937935866E385ED4DE1FD95AA686C18A267E075 * L_25 = __this->get_profile_9();
			NullCheck(L_25);
...
IL_00e4:
		{
			// if (profile.HaltAudioOnTrackingLost)
			LostTrackingServiceProfile_t4937935866E385ED4DE1FD95AA686C18A267E075 * L_28 = __this->get_profile_9();
			NullCheck(L_28);
...
IL_00fe:
		{
			...
			LostTrackingServiceProfile_t4937935866E385ED4DE1FD95AA686C18A267E075 * L_33 = __this->get_profile_9();
			NullCheck(L_33);
...
IL_0018:
	...
	}
	{
		...
		List_1_tEBCACF3020237BB50A4939671B915A00276FC85C * L_5 = ((LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583_StaticFields*)il2cpp_codegen_static_fields_for(LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583_il2cpp_TypeInfo_var))->get_XRSessionSubsystems_21();
		NullCheck(L_5);
...
IL_003c:
		{
			...
			XRSessionSubsystem_t9B9C16B4BDB611559FB6FA728BE399001E47EFF0 * L_8 = V_2;
			NullCheck(L_8);
			bool L_9 = VirtFuncInvoker0< bool >::Invoke(4 /* System.Boolean UnityEngine.Subsystem::get_running() */, L_8);
			V_3 = L_9;
			bool L_10 = V_3;
			if (!L_10)
			{
...
IL_004f:
		{
			...
			IL2CPP_RUNTIME_CLASS_INIT(LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583_il2cpp_TypeInfo_var);
			((LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583_StaticFields*)il2cpp_codegen_static_fields_for(LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583_il2cpp_TypeInfo_var))->set_sessionSubsystem_20(L_11);
			// break;
			goto IL_0062;
		}
...
IL_0074:
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583_il2cpp_TypeInfo_var);
		XRSessionSubsystem_t9B9C16B4BDB611559FB6FA728BE399001E47EFF0 * L_13 = ((LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583_StaticFields*)il2cpp_codegen_static_fields_for(LostTrackingService_t57018C94810BD260837E9FD9D87109A996240583_il2cpp_TypeInfo_var))->get_sessionSubsystem_20();
		V_4 = L_13;
		goto IL_007d;
	}
